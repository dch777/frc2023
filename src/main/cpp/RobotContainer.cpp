  ...
  /*m_drive.SetDefaultCommand(frc2::RunCommand(
      [this] {
        m_drive.Drive(units::meters_per_second_t{m_driveController.GetRawAxis(OIConstants::LY)},
                      ...
                      units::radians_per_second_t{m_driveController.GetRawAxis(OIConstants::RX)}, false);
      },
      {&m_drive}));*/
}
...
void RobotContainer::ConfigureButtonBindings() {
  ...
  frc2::JoystickButton(&m_driveController, OIConstants::X).WhenReleased(
    frc2::InstantCommand(
      [this] {
  ...
  frc2::JoystickButton(&m_armController, OIConstants::RB).WhenHeld(
    frc2::StartEndCommand(
      [this] {
        m_grabber.SetSpeed(0.2);
      },
      [this] {
  ...
  frc2::JoystickButton(&m_armController, OIConstants::LB).WhenHeld(
    frc2::StartEndCommand(
      [this] {
        m_grabber.SetSpeed(-0.2);
      },
  ...
  frc2::JoystickButton(&m_armController, OIConstants::LPress).ToggleWhenPressed(
    frc2::StartEndCommand(
      [this] {
        m_grabber.SetSpeed(-0.2);
      },
...
frc2::Command* RobotContainer::GetAutonomousCommand() {
  return new Auto(&m_drive, &m_wrist, &m_arm, &m_grabber);
}
